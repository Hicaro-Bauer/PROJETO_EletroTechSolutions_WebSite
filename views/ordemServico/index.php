                ...
                <form action="../../controller/AgendamentoController.php" method="post">
                    ...
                    <article class="artContainer">
                        <section class="secInput">
                            ...
                            <textarea id="textArea" name="formf" placeholder="Descreva qual foi a solução"><?= $result['formf'] ?></textarea>
                        </section>

                    </article>  
                    <input class="input_hidden" type="text" name="idagenda" value="<?= $_GET['idagenda']?>" hidden>
                    <button class="btn2" name="concluir">ENVIAR ORDEM</button>
                </form>
            </article>
